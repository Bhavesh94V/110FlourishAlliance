                                    ...
                                    <div className="col-md-6 mt-md-2 m-0">
                                        ...
                                        <div className="row md:mt-5">
                                            ...
                                            <div className="col-lg-12 my-4">
                                                <a className="btn btn-small btn-info" href="#">Apply for Your Business Visa Now</a>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div className="container py-5">
                        ...
                        <div className="row g-4 align-items-center">
                            ...
                            <div className="col-lg-12 col-xl-4 wow fadeInUp" data-wow-delay="0.2s">
                                <img src={StudyVisa} className="img-fluid h-[330px] object-cover rounded-lg" alt="Business Visa" />
                            </div>
